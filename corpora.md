...
- **Where:** Not yet public. Sample format mirrored at: [jak-ma-eval-suite/data/sample_queries.jsonl](https://github.com/selakkad2003/jak-ma-eval-suite/blob/main/data/sample_queries.jsonl).
...
3. **Calibrated evaluators.** Most public Darija evaluation is one-shot human rating with no calibration protocol. The methodology in [ernie-evaluation-notes/calibration_practice.md](https://github.com/selakkad2003/ernie-evaluation-notes/blob/main/calibration_practice.md) is what closes this gap.
...
6. **Eval against MADAR-26 held-out** + your own 50-query Darija test set (see [jak-ma-eval-suite](https://github.com/selakkad2003/jak-ma-eval-suite)).

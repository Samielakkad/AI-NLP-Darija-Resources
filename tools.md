...
- **Recipe:** See [jak-ma-eval-suite/scripts/finetune/lora_train.py](https://github.com/selakkad2003/jak-ma-eval-suite) for a working template (target: Llama 3.1 8B, rank 16, alpha 32).
...
- **Install:** Clone https://github.com/selakkad2003/jak-ma-eval-suite + `pip install httpx tqdm`
...
- **Index recipe (jak.ma):** `(category, city, approved, available)`, `(category, featured, verified, rating)`. See [jak-ma-eval-suite/VERIFIER_SPEC.md](https://github.com/selakkad2003/jak-ma-eval-suite).
...
4. **Eval:** [jak-ma-eval-suite/scripts/run_eval.py](https://github.com/selakkad2003/jak-ma-eval-suite) against a domain-specific test set you build
5. **Hosting:** Vercel serverless (you'll outgrow it at ~200k queries/month, but it's free at the start)
6. **Verifier:** Deterministic rules in code, no LLM call inside the verifier (see [jak-ma-eval-suite/VERIFIER_SPEC.md](https://github.com/selakkad2003/jak-ma-eval-suite/blob/main/VERIFIER_SPEC.md))

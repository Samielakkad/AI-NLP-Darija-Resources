...
- Hand-curated jak.ma worker descriptions (sample dataset in [jak-ma-eval-suite](https://github.com/selakkad2003/jak-ma-eval-suite))
...
- **Hugging Face PEFT (LoRA)** — what we use in the [jak-ma-eval-suite](https://github.com/selakkad2003/jak-ma-eval-suite) fine-tune scaffolding.
...
The 50-prompt held-out test set for jak.ma's grounded retrieval is in [jak-ma-eval-suite/DARIJA_QUERY_SET.md](https://github.com/selakkad2003/jak-ma-eval-suite/blob/main/DARIJA_QUERY_SET.md). Production-validated, scores ≥0.92 aggregate as of May 2026.
...
3. **Calibrated evaluators.** Most public Darija evaluation is one-shot human rating with no calibration protocol. Build your rubric early (see [ernie-evaluation-notes](https://github.com/selakkad2003/ernie-evaluation-notes) for methodology).
...
- [jak-ma-eval-suite](https://github.com/selakkad2003/jak-ma-eval-suite) — production grounded-retrieval eval methodology
- [ernie-evaluation-notes](https://github.com/selakkad2003/ernie-evaluation-notes) — LLM eval methodology from Baidu ERNIE Mentor Program
